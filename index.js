...
const sessdata = config.SESSION_ID.replace("NIGHTMARE-MD~", '');
...
console.log("CONNECTING NIGHTMARE-MD 🧬...");
...
console.log('NIGHTMARE-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ NIGHTMARE-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ꜱᴀᴊɪᴅ-xᴅ ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029VbAiTE16xCSKuZB8Fj2L*
...
//================ownerreact==============
if(senderNumber.includes("9232511111111")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("9232517111111")){
if(isReact) return
m.react("👑")
}
...
app.get("/", (req, res) => {
res.send("HEY, NIGHTMARE-MD STARTED ✅");
});
